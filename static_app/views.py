...
def BlogDetail(request,slug):
    ...
    return render(request, template_name,{'blog':blog,'costomer_service':costomer_service,'heading':heading})
...
def AboutUs(request):
    ...
    return render(request, template_name,{"about":about,'costomer_service':costomer_service})
